    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7 text-center">
                <h2 class="featurette-heading text-left">RV & Boat Storage<br/>1 Minute from Highway 50 West</span></h2>
                <p class="lead text-left">Right off Highway 50 in Shingle Springs, Family RV Storage offers paved and well-lit storage space with high
                            security and easy access. Close to Gas, Food, and other amenities. Come and join our Family.</p>
